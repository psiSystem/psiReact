 ...
 * @Component
 * 
 * @Order(Ordered.HIGHEST_PRECEDENCE) public class RequestFilter implements
 * Filter {
 * 
 * public void doFilter(ServletRequest req, ServletResponse res, FilterChain
 * chain) { HttpServletResponse response = (HttpServletResponse) res;
 * HttpServletRequest request = (HttpServletRequest) req;
 * 
 * response.setHeader("Access-Control-Allow-Origin", "/index");
 ...
 * else { response.setHeader("Access-Control-Allow-Methods", "POST,GET,DELETE");
 * response.setHeader("Access-Control-Max-Age", "3600");
